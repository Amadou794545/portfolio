...
const skills = [
  ...
  { name: "PostgreSQL", type: "hardskills" },
  { name: "Airflow", type: "hardskills" },
  { name: "Google Cloud", type: "hardskills" },
  { name: "BigQuery", type: "hardskills" },
  { name: "deeplearning", type: "hardskills" },
